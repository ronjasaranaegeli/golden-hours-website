...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-white font-sans relative z-10"
      ref={containerRef}
    >
      <div className="max-w-5xl mx-auto pt-28 pb-16 px-4 md:px-8 lg:px-10 text-center">
        <h2 className="text-2xl md:text-5xl mb-5 text-forest-900 font-serif font-medium relative inline-block">
          Golden Hours
