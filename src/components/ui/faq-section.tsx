  ...
  ({ className, title, description, items, contactInfo, ...props }, ref) => {
    return (
      <section
        ref={ref}
        className={cn(
          "py-8 sm:py-16 w-full bg-gradient-to-b from-transparent via-muted/50 to-transparent",
          className
        )}
        {...props}
      >
        <div className="container px-3 sm:px-4">
          ...
          <motion.div
            ...
            className="max-w-2xl mx-auto text-center mb-6 sm:mb-12"
          >
            <h2 className="text-2xl sm:text-3xl font-semibold mb-3 font-serif">
              {title}
            </h2>
            {description && (
          ...
          {/* FAQ Items */}
          <div className="mx-auto space-y-2 max-w-full sm:max-w-3xl">
  ...
  return (
    ...
    >
      <Button
        ...
        className="w-full px-3 sm:px-6 py-3 sm:py-4 h-auto flex hover:bg-transparent text-left"
      >
        <div className="flex-grow overflow-hidden mr-2">
          <h3
            className={cn(
              "text-sm sm:text-base font-medium transition-colors duration-200 text-left",
              "text-foreground/70 break-words",
