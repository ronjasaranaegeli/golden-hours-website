          ...
          <div className="p-8 md:p-12 reveal flex flex-col" ref={formRef}>
            <div>
              ...
              <p className="text-lg mb-6 text-forest-600">
                Die Räume für den 1:1 Deep Dive sind vom 11.02.2025 bis zum 01.02.2026 für dich geöffnet. Wenn du dich in dieser Zeit für deinen Platz entscheidest, trittst du in einen geschützten Raum voller Transformation und Wachstum ein. Danach bleiben die Türen geschlossen - und meine volle Präsenz gilt den Menschen, die in diesem Zeitfenster ihre Reise begonnen haben.
              </p>
            ...
            <div className="mt-auto pt-8 pb-4 relative">
              ...
              <Button asChild className="w-auto px-8 py-3 bg-[#c7964c] hover:bg-[#b3873d] text-white font-medium" size="default">
                <a href="https://form.jotform.com/251244295429056" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
                  <span>1:1 Deep Dive Check-in</span>
